    ...
    return (
        <>
            ...
            <div className='w-100 bg-two'>
                <div className='logos'>
                    <Image loading='lazy' src='/senaverde.png' height={100} width={100} alt="logo del sena" />
                    <Image loading='lazy' src='/fondoemprender.png' height={100} width={100} alt="logo del fondo emprender" />
                    <Image loading='lazy' src='/escudo.png' height={100} width={100} alt="Escudo de la republica de colombia" />
                    <Image loading='lazy' src='/corazon.png' height={100} width={100} alt="Logo Alcaldía de Monterrey" />
                </div>
            </div>
        </>
    )
